...
- [x] I completed Chapters 1-8 of Linux Basics for Hackers (or equivalent)
...
- [x] I can use pipes and redirects to chain commands
- [x] I understand basic bash scripting concepts